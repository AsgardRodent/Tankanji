...
const SignUp = () => {
  ...
  <div className="relative">
    <div className='absolute left-1/2 -top-10 transform -translate-x-1/2 bg-blue-500 w-[80px] h-[80px] rounded-full z-10 kk-icon border-4 border-[rgba(217, 217, 217, 0.8)]'></div>
